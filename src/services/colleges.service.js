...
export const getColleges = async function () {
...
export const getDepartmentsForACollege = async function (collegeCode) {
...
export const getProgrammesForADepartment = async function (departmentCode) {
